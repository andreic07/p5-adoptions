...
public class AnimalStore

    {
        ...
        {{
            add(new Dog("Alfi","https://www.colecteaza.ro/wp-content/uploads/2018/05/dog.jpg", 4));
            add(new Dog("Max","https://cdn.mos.cms.futurecdn.net/QjuZKXnkLQgsYsL98uhL9X-1200-80.jpg", 5));
            add(new Dog("Luchi","https://thegarnetmine.com/wp-content/uploads/2021/04/Dog.jpeg", 6));
